...
- [X] Add request body parameters
- [X] Grab the parameters from the front-end
- [X] Hardcode a merkle root here representing the whole nice list
- [X] Prove that a name is in the list 
